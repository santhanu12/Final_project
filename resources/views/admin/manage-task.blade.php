...
<div class="modal fade" id="modal-default">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="/adminadd-task" class="add-task" id="add-task" method="post">
                @csrf
                <input type="hidden" name="manager_id" id="manager_id" value="">
                <input type="hidden" name="user_id" class="user_id" id="user_id" value="">
                <input type="hidden" name="admin_id" class="admin_id" id="admin_id" value="">
...
<div class="modal fade" id="edit-task-details">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="/adminedit-task" class="edit-task" id="edit-task" method="post">
                @csrf
...
$(document).ready(function(){
  ...
  var gettasks = "{{ route('admingetTasks') }}";
